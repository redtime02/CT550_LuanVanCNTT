...
const CollectListScreen = ({navigation}) => {
  const [comments, setComments] = useState([]);

  useEffect(() => {
    // Gọi API để lấy dữ liệu từ localhost:3000/api/blog
    axios
      .get('http://10.13.128.162:3000/api/location/collect-by')
      .then(response => {
          ...
          <TouchableOpacity>
            <View style={styles.container}>
              ...
              <View style={styles.content}>
                ...
                <Text style={styles.time}>
                  Ngày thu nhặt: {formatDateTime(List.updatedAt)}
                </Text>
              </View>
            </View>
          </TouchableOpacity>
...
export default CollectListScreen;
