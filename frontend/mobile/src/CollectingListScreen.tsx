...
const CollectingListScreen = ({navigation}) => {
  const [comments, setComments] = useState([]);

  useEffect(() => {
    // Gọi API để lấy dữ liệu từ localhost:3000/api/blog
    axios
      .get('http://10.13.128.162:3000/api/location/get-collecting-by')
      .then(response => {
          ...
          <TouchableOpacity>
            <View style={styles.container}>
              ...
              <View style={styles.content}>
                ...
                <Text style={styles.time}>
                  Xác nhận thu nhặt bởi: {List.collectingBy.name}
                </Text>
              </View>
            </View>
          </TouchableOpacity>
...
export default CollectingListScreen;
